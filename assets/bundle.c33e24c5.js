            ...
            x && (n["--aceh"] = "1"),
                a.headers.forEach((a, o) => {
                        "user-agent" !== o && (!function (a, o) {
                            if ("content-type" === a) {
                                // return "application/x-www-form-urlencoded" === o || "multipart/form-data" === o || "text/plain" === o
                                return true;
                            } else {
                                if ("accept" === a || "accept-language" === a || "content-language" === a) {
                                    return o.length < 256 && !S.test(o)
                                } else {
                                    return void 0
                                }
                            }
